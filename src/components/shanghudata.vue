    ...
    <div>
        <Row style="margin-bottom:10px;">
            <Col span="24">
                ...
                <Input icon="ios-search" v-model="page.pdata.shopid" @on-enter="search" @on-click="search" placeholder="输入用户ID" style="width: 150px" />
	    ...
	    data : function(){
            return {
                ...
                columns : [
                    ...
                    {title:'商户名称',key:'user',slot: 'user',width:200},
                    {title:'用户名称',key:'name',slot: 'name',width:200},
                
                    {title:'金额',key:"fee",slot: 'fee',width:90},
                    {title:'支付后金额',key:"data",slot: 'data',width:100},
                    {title:'类型',key:'other',slot: 'other',width:120},
                    {title:'时间',key:'status',slot: 'status',width:150},
                    
                ],
                types : [{label:'订单销售收入',value:1},{label:'系统变动',value:2},{label:'提现支出',value:3},{label:'退回提现',value:5},{label:'转为卡券红包扣除',value:7},{label:'在线买单',value:9}],
                page : {
                    pdata : {
