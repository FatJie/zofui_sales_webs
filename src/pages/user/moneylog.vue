                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <p>
                            <!-- <Poptip
                                confirm
                                title="确定删除此条数据吗？"
                                @on-ok="dealthis(row.id, page.pdata.type == 'money' ? 'deletemlog' : 'deleteumlog')"
                                placement="left">
                                <a>删除</a>
                            </Poptip> -->
                        </p>
            ...
            <Col span="6">
                <!-- <Dropdown trigger="click" placement="top" @on-click="dealselect">
                    ...
                    <DropdownMenu slot="list">
                        <DropdownItem :name="page.pdata.type == 'money' ? 'deleteallmlog' : 'deleteumlog'">删除数据</DropdownItem>
                    </DropdownMenu>
                </Dropdown> -->
            </Col>
            <Col span="18">
        ...
        created:function(){
	  	...
	  	methods: {
            ...
            initData(){
                ...
                if( params.id ){
                    self.page.pdata.uid = params.id;
                }
                if( params.uid ){
                    self.page.pdata.uid = params.uid;
                }
                if(params.type == 'umoney'){
                    self.page.pdata.type = 'umoney';
                }
