<template>
	<div>
        ...
        <Button type="primary" @click="link" data-url="/addhelp" style="margin-bottom:10px;">添加问答</Button>
        <Row>
            <Col span="24">
                <Table ref="selection" :columns="columns" :data="list" @on-select="selectTable" @on-select-cancel="selectTable" @on-select-all="selectTable">
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <p>
                            <a href="javascript:;" @click="link" :data-url="'addhelp?id='+row.id"  >编辑</a>
                            <Poptip
                                confirm
                                title="确定删除此条数据吗？"
            ...
            <Col span="6">
                <Dropdown trigger="click" placement="top" @on-click="dealselect">
                    ...
                    <DropdownMenu slot="list">
                        <DropdownItem name="delall">删除数据</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </Col>
            <Col span="18">
