<template>
	<div>
        ...
        <Tabs value="signlist" @on-click="changetab">
            ...
            <Col span="24">
                <Table ref="selection" :columns="columns" :data="list" @on-select="selectTable" @on-select-cancel="selectTable" @on-select-all="selectTable">
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <p>
                            <a @click="link" :data-url="'signadd?id='+row.id"  >编辑</a>
                            <Poptip
                                confirm
                                title="确定删除吗？"
                                @on-ok="dealthis(row.id,'delsignprize')"
                                placement="left">
                                <a>删除</a>
                            </Poptip>
            ...
            <Col span="6">
                ...
                <Dropdown trigger="click" placement="top" @on-click="dealselect">
                    ...
                    <DropdownMenu slot="list">
                        <DropdownItem name="deletesignprize">删除数据</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </Col>
            <Col span="18">
	  	...
	  	data : function(){
	  		return {
                ...
                columns : [
                    ...
                    {title:'名称',key:'name'},
                    {title:'需要完成数量',key:"need"},
                    {title:'发放次数',key:"sended"},
                    {title:'状态',key:'err'},
