<template>
    <div>
        ...
        <Tabs value="questanswer" @on-click="changetab">
        ...
        <Row style="margin-bottom:10px;">
            <Col span="24">
                ...
                <Input icon="ios-search" v-model="page.pdata.qid" @on-enter="search" @on-click="search" placeholder="输入提问ID" style="width: 150px" />
            </Col>
        </Row>
        ...
        <Row>
            <Col span="24">
                <Table ref="selection" :columns="columns" :data="list" @on-select="selectTable" @on-select-cancel="selectTable" @on-select-all="selectTable">
                    ...
                    <template slot-scope="{ row }" slot="quest">
                        <p >{{row.quest.title}}</p>
                        <p >id:{{row.quest.id}}</p>
                    </template>
            ...
            <Col span="6">
                ...
                <Dropdown trigger="click" placement="top" @on-click="dealselect">
                    ...
                    <DropdownMenu slot="list">
                        <DropdownItem name="deleteallanswer">删除数据</DropdownItem>
                        <DropdownItem name="allanswerup">上架</DropdownItem>
                        <DropdownItem name="allanswerdown">下架</DropdownItem>
                        <DropdownItem name="allanswerpass">通过审核</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </Col>
            <Col span="18">
        ...
        data : function(){
            return {
                ...
                columns : [
                    ...
                    {title:'问题',key:'quest',slot:'quest'},
                    {title:'回答者',key:"user",slot: 'user',},
                    {title:'回答内容',key:"content"},
                    {title:'有用',key:"zan"},
