            ...
            <Col span="24">
                <Table ref="selection" :columns="columns" :data="list">
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        ...
                        <a href="javascript:;" @click="dealthis(row.id,'delfxuser')" >取消{{settings.fxbname}}员</a>
                        <a href="javascript:;" @click="link" :data-url="'/adminuserdown?parent='+row.uid" >查看下级</a>
                        <p>
                            <a href="javascript:;" @click="link" :data-url="'/adminorder?saler='+row.uid" >查看{{settings.fxbname}}订单</a>
                        </p>
                    </template>
                </Table>
	  	...
	  	data : function(){
	  		return {
                ...
                columns : [
                    ...
                    {title:'下级数量',key:'downnum'},
                    {title:this.settings.fxbname+'数量',key:'fxnum'},
