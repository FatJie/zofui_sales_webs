<template>
    ...
    <div v-if="gtype*1 < 0">
        ...
        <Button v-if="!settings.isquick && ( !shop.auth || shop.auth.isxq != 0)" shape="circle" @click="addgtype(1)">限抢{{settings.goodbname}}</Button>
        <Button v-if="!settings.isgroup && (!shop.auth || shop.auth.ispin != 0)" shape="circle" @click="addgtype(2)">拼团{{settings.goodbname}}</Button>
        <Button v-if="!settings.iscut && (!shop.auth || shop.auth.iscut != 0)" shape="circle" @click="addgtype(3)">砍价{{settings.goodbname}}</Button>
        <Button v-if="!settings.isbm && (!shop.auth || shop.auth.isbm != 0)" shape="circle" @click="addgtype(4)">报名{{settings.goodbname}}</Button>
        <Button v-if="!settings.ischou && (!shop.auth || shop.auth.ischou != 0)" shape="circle" @click="addgtype(5)">抽奖活动</Button>
        <Button v-if="!settings.isms && (!shop.auth || shop.auth.isms != 0)" shape="circle" @click="addgtype(6)">秒杀{{settings.goodbname}}</Button>
        <Button v-if="!settings.istequan && (!shop.auth || shop.auth.istequan != 0)" shape="circle" @click="addgtype(8)">特权{{settings.goodbname}}</Button>
        <Button v-if="!settings.islibao && (!shop.auth || shop.auth.islibao != 0)" shape="circle" @click="addgtype(9)">礼包{{settings.goodbname}}</Button>
    </div>
    ...
    <template v-else>
        <Tabs value="basic" @on-click="changetab">
           ...
           <!--<TabPane label="资金参数" name="money" ></TabPane>-->
            ...
            <TabPane label="规格预约" name="rule" v-if="gtype != 3 && gtype != 5 && gtype != 8"></TabPane> -->
        ...
        <div v-show="tabtype == 'basic'">
            ...
            <Row class="frm_group">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <label>填写商品标题，精准描述产品信息，吸引用户关注</label>
                </Col>
            </Row>
            <Row class="frm_group " type="flex" align="middle" >
                ...
                <Col span="18" class="frm_content">
                    ...
                    <label>商品页面展示主图，请上传长方形产品图，确保商品美观</label>
            ...
            <Row class="frm_group " type="flex" align="middle" >
                ...
                <Col span="18" class="frm_content">
                    ...
                    <label for="">首页展示主图，请上传长方形产品图，确保商品美观</label>
            ...
            <Row class="frm_group " type="flex" align="middle" v-if="!settings.fontsty || settings.fontsty == 0">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <label for="">商品轮播图，请上传尺寸一致的产品图，确保商品美观</label>
           ...
           <!-- <Row class="frm_group">
            ...
            <Row class="frm_group" v-if="gtype == 8">
                ...
                <Col span="18" class="frm_content">
                    <!-- <Select filterable :value="goods.receive" class="w400">
                        <Option v-for="item in classes" :value="item.id" :key="item.id">{{ item.name }}</Option>
                    </Select> -->
                    <Cascader class="w400" filterable @on-change="setgrade" :data="classes" clearable  :value="[goods.receive]"></Cascader>
                    <p class="frm_tip">抽奖类不可使用</p>
                </Col>
            </Row>
            <Row class="frm_group" v-if="gtype == 8 && goods.receive==1">
                <Col span="3" class="frm_title">
                    VIP限领等级
                </Col>
                <Col span="18" class="frm_content">
                    <Cascader class="w400" filterable @on-change="setforever" :data="forever" clearable  :value="[goods.isforever]"></Cascader>
                    <p class="frm_tip">不选默认为非长期会员</p>
                </Col>
            </Row>
                ...
                <Row class="frm_group">
                    ...
                    <Col span="18" class="frm_content">
                        <div class="mb10">
                            ...
                            <!-- 会员价<Input v-model="goods.price" placeholder="用户购买价" class="w100" />元，
                            <template v-if="settings.isucard == 0">
                            结算价<Input v-model="goods.userprice" placeholder="商户与平台结算价" class="w150" />元。
                            </template> -->
                        </div>
                        <p class="frm_tip"></p>
                    </Col>
                ...
                <Row class="frm_group" >
                    ...
                    <Col span="18" class="frm_content">
                        <div class="mb10">
                            ...
                            每人限抢<Input v-model="goods.quicklimit" placeholder="" class="w100" />件，会员抢购价
                            <Input v-model="goods.quickprice" placeholder="" class="w100" />元,
                            <template v-if="settings.isucard == 0">
                           结算价<Input v-model="goods.quickuserprice" placeholder="" class="w100" />元。
                            </template>
                ...
                <Row class="frm_group" >
                    ...
                    <Col span="18" class="frm_content">
                        <div class="mb10">
                            ...
                            <template v-if="settings.isucard == 0">
                            ，结算价<Input v-model="goods.guserprice" placeholder="" class="w100" />元。
                            </template>
                            <template v-if="settings.isucard == 0 && settings.ismpr == 1 && settings.isum == 1">
                    ...
                    <Col span="18" class="frm_content">
                        <Card class="mb10">
                            ...
                            <div v-for="(item,index) in groupparams" class="mb20">
                                ...
                                ，会员拼团价<Input v-model="item.groupp" placeholder="" class="w70" />元
                                <!-- <template v-if="settings.isucard == 0">
            ...
            <template v-if="gtype == 9">
                ...
                <Row class="frm_group">
                    ...
                    <Col span="18" class="frm_content">
                        <div class="mb10">
                            库存<Input v-model="goods.stock" placeholder="" class="w100" />件，
                            <!-- 会员价<Input v-model="goods.price" placeholder="" class="w100" />元，
                            <template v-if="settings.isucard == 0">
                            结算价<Input v-model="goods.userprice" placeholder="" class="w100" />元。
                            </template> -->
            ...
            <Row class="frm_group" v-if="settings.editss == 0">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <P class="frm_tip">填入数字，前端会显示此数据加真实销量，增加人气，不建议使用</P>
                </Col>
            </Row>
            <Row class="frm_group" v-if="settings.editsa == 1">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <P class="frm_tip">填入数字，前端会显示此数据加真实分享，增加人气，不建议使用</P>
                </Col>
            </Row>
            <Row class="frm_group" v-if="settings.editsa == 1">
                <Col span="3" class="frm_title">
            ...
            <!--<Row class="frm_group" v-if="!goods.sfailot">
             ...
             <!--<Row class="frm_group" v-if="settings.isucard == 0">
                <Col span="3" class="frm_title">
                    限制购买/参与
                </Col>
                <Col span="18" class="frm_content">
                    <RadioGroup v-model="goods.isuser">
                        ...
                        <Radio label="3" >仅限管理员购买</Radio>
                    </RadioGroup>
                    <p class="frm_tip">设置仅限会员购买/参与后，只有升级了的会员才能购买/参与，仅限管理员购买适合预先购买测试的情况</p>
                </Col>
            </Row>-->
            ...
            <!--<Row class="frm_group" v-if="settings.isgquest == 1">
             ...
             <Row class="frm_group">
                ...
                <Col span="18" class="frm_content">
                    <editor class="w750" :editorhtml="goods.contents" fnname="contentsedit" @contentsedit="contentsedit" type="admin" :shopid="shop.id" :uniacid="shop.uniacid"></editor>
                </Col>
            </Row>
        </div>
        <div v-show="tabtype == 'money'">
            ...
            <Row class="frm_group" >
                ...
                <Col span="18" class="frm_content">
                    <RadioGroup v-model="goods.shopnum">
                        <Radio label="0" >默认</Radio>
                        <Radio label="1" >只能选择一个</Radio>
                    </RadioGroup>
                    <p class="frm_tip" >若选第一个，不要求选择门店，门店在到店详情里都显示。若选择第二个，那么下单的时候要求选择一个店铺</p>
                </Col>
            </Row>
            <Row class="frm_group" v-if="goods.istoshop == 0 || !goods.istoshop">
                <Col span="3" class="frm_title">
                    {{settings.fontsty== 0 ? '可领取门店' : '线下门店'}}
                </Col>
                <Col span="18" class="frm_content">
            ...
            <Row class="frm_group" v-if="settings.jfpay*1 > 0 && settings.gjfmm*1 == 0">
                <Col span="3" class="frm_title">
                    积分抵扣
                </Col>
                <Col span="18" class="frm_content">
                    <RadioGroup v-model="goods.isjfdk">
                        <Radio label="0">参与抵扣</Radio>
                        <Radio label="1">不参与抵扣</Radio>
                    </RadioGroup>
                    <p class="frm_tip" ></p>
                </Col>
            </Row>
            <Row class="frm_group" >
                ...
                <Col span="18" class="frm_content">
                    <RadioGroup v-model="goods.mper">
                        <Radio label="0" >按比例</Radio>
                        <Radio label="1">按固定值</Radio>
                    </RadioGroup>
                    <p class="frm_tip">若选择固定值请自行设计考虑好收支：支付金额必须大于返现金额+服务费+{{settings.fxbname}}金额，若设置的收入金额小于支出金额将不能下单</p>
                </Col>
            </Row>
            <template v-f="settings.isfan == 1">
                <Row class="frm_group" >
                    <Col span="3" class="frm_title">
                        购物返现
                    </Col>
                    <Col span="18" class="frm_content">
                       返现 <Input v-model="goods.fanx" type="text" class="w100"  placeholder="" />{{goods.mper == 1 ? '元' : '%'}}
                       <template v-if="settings.isucard == 0">
                           会员返现 <Input v-model="goods.userfanx" type="text" class="w100"  placeholder="" />{{goods.mper == 1 ? '元' : '%'}}
                       </template>
                        <p class="frm_tip">单位/{{goods.mper == 1 ? '元' : '%'}}，填入数字。购买完成后返给买家的金币</p>
                    </Col>
                </Row>
                <Row class="frm_group" >
                    <Col span="3" class="frm_title">
                    ...
                    <Col span="18" class="frm_content">
                        <RadioGroup v-model="goods.fanxtype">
                            <Radio label="0" >关闭</Radio>
                            <Radio label="1">按天周期返</Radio>
                            <Radio label="2">间隔时间返相同金额</Radio>
                        </RadioGroup>
                    </Col>
                </Row>
                <Row class="frm_group" v-if="goods.fanxtype == 1">
                    <Col span="3" class="frm_title">
                        返现周期
                    </Col>
                    <Col span="18" class="frm_content">
                        <div class="mb10" v-for="(item,index) in fanxday">
                            第 <Input v-model="fanxday[index]" placeholder="" class="w100"  />
                            天，返<Input v-model="fanxper[index]" placeholder="" class="w100"  />{{goods.mper == 1 ? '元' : '%'}}
                            <a href="javascript:;" @click="delfanx(index)">删除</a>
                        </div>
                        <a href="javascript:;" @click="addfanx">添加一项</a>
                    </Col>
                </Row>
                <Row class="frm_group" v-if="goods.fanxtype == 2">
                    <Col span="3" class="frm_title">
                        返现周期
                    </Col>
                    <Col span="18" class="frm_content">
                       分 <Input v-model="goods.fanxtimes" type="text" class="w100"  placeholder="" />次返完,
                        
                        间隔 <Input v-model="goods.fanxtime" type="text" class="w100"  placeholder="" />小时返一次
                       
                        <p class="frm_tip">每次返的金额是一致的，按总返现金额平分，若计算平均值小于0.01则只返一次</p>
                    </Col>
                </Row>
            </template>
                ...
                <Row class="frm_group">
                    ...
                    <Col span="18" class="frm_content">
                        <div class="mb10">
                            ...
                            <template v-if="settings.isucard == 0">
                            会员现价<Input v-model="goods.userprice" placeholder="" class="w100" />元。
                            </template>
                            <template v-if="settings.isucard == 0 && settings.ismpr == 1 && settings.isum == 1">
                            会员余额价<Input v-model="goods.userpricejb" placeholder="" class="w100" />元。
                            </template>
        ...
        <div v-show="tabtype == 'many'">
            <Row class="frm_group">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <p class="frm_tip">这个是用作分享的标题文字，字数建议在25个字以内</p>
                </Col>
            </Row>
            <Row class="frm_group" v-if="settings.fontsty== 0">
                ...
                <Col span="18" class="frm_content">
                    ...
                    <p class="frm_tip">转发到群后的文字描述内容（公众号分享才有效），字数建议在25个字以内</p>
                </Col>
            </Row>
            ...
            <Row class="frm_group" >
                ...
                <Col span="18" class="frm_content">
                    ...
                    <p class="frm_tip">转发朋友圈文案，详情点击分享进入素材后提示复制的内容</p>
                </Col>
            </Row>
            <Row class="frm_group " type="flex" >
                <Col span="3" class="frm_title">
        ...
        <div v-show="tabtype == 'rule'">
           ...
           <!-- <Row class="frm_group" >
            ...
            <Row class="frm_group" v-if="shop.auth && shop.auth.isfx != 1 && settings.fxlevel != 3">
                ...
                <Col span="18" class="frm_content">
                    <RadioGroup v-model="goods.fxisrule">
                        <Radio label="0" >使用资金参数里的</Radio>
                        <Radio label="1">使用规格独立设置的</Radio>
                    </RadioGroup>
                    <div class="frm_tip" v-if="shop.isdzpaym == 0 && shop.isdzpay == 1 && settings.isdzpay == 1">
                        账户活动余额充足才可以发分销佣金。当前账户活动资金余额：{{shop.actmoney}}，
                        <Dropdown trigger="click" placement="top-start" >
                    ...
                    <Card class="mt10">
                        <Row class="mb10">
                            <Col span="3" class="pd5">
                                <Input v-model="setprice.nowprice" placeholder="现价"   />
                            </Col>
                            <Col span="3" class="pd5">
                                <Input v-model="setprice.uprice" placeholder="会员现价" />
                            </Col>
                            ...
                            <!-- <Col span="3" class="pd5" v-if="shop.auth && shop.auth.isfx != 1 && settings.fxlevel != 3">
                                <Input v-model="setprice.fxa" placeholder="一级分销佣金" />
                            </Col>
                            <Col span="3" class="pd5" v-if="shop.auth && shop.auth.isfx != 1 && settings.fxlevel >= 1">
                                <Input v-model="setprice.fxb" placeholder="二级分销佣金" />
                            </Col>
                            <Col span="3" class="pd5" v-if="shop.auth && shop.auth.isfx != 1 && settings.fxlevel >= 2">
                                <Input v-model="setprice.fxc" placeholder="三级分销佣金" />
                            </Col> -->
                            <Col span="3" class="pd5">
        ...
        <div v-show="tabtype == 'info'">    
            ...
            <Row class="frm_group" v-if="settings.gsinfo == 1">
                <Col span="3" class="frm_title">
                    {{settings.shopbname}}详情
                </Col>
                <Col span="18" class="frm_content">
                    <editor class="w750" :editorhtml="goods.shopinfo" fnname="shopinfo" @shopinfo="shopinfo" ></editor>
                </Col>
            </Row>
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            setgrade(e){
                if( e[0] ){
                    this.goods.receive = e[0];
                };
            },
            setforever(e){
                if( e[0] ){
                    this.goods.isforever = e[0];
                }
            },
            shopedit(e){
            ...
            contentsedit(e){
               this.$set(this.goods,'contents',e);
            },
            shopinfo(e){
                    ...
                    if( res.status == 200 ){
                        ...
                        if( res.obj.info ){
                            ...
                            if( res.obj.info.type == 1 ){
                                ...
                                if(res.obj.info.receive){
                                    self.goods.receive=res.obj.info.receive;
                                }
                                if(res.obj.info.isforever){
                                    self.goods.isforever=res.obj.info.isforever;
                                }
                            }
