	...
	<div>
		...
		<Card title="订单" style="margin-top: 10px;">
            ...
            <Row class="frm_group">
                ...
                <Col span="18" class="frm_content">
                    {{orderinfo.shopfee}} （ 平台服务费{{orderinfo.sever}}，{{settings.fxbname}}支出 {{orderinfo.salerfee*1 + orderinfo.salerfeea*1 + orderinfo.salerfeeb*1 }} ,返现{{orderinfo.fanxianm}} ）
                </Col>
            </Row>
            ...
            <Row class="frm_group" v-if="orderinfo.jifendis > 0">
                <Col span="3" class="frm_title">
                    积分抵扣
                </Col>
                <Col span="18" class="frm_content">
            ...
            <Row class="frm_group" v-if="orderinfo.taketype == 1 && settings.iscomo == 0">
                <Col span="3" class="frm_title">
                    {{settings.hxbname}}编码
                </Col>
                <Col span="18" class="frm_content">
            ...
            <Row class="frm_group" v-if="orderinfo.isdzpay == 1">
                <Col span="3" class="frm_title">
                    收款方
                </Col>
                <Col span="18" class="frm_content">
                    商户独立收款,收款商户号{{orderinfo.submchid}}
                </Col>
            </Row>
